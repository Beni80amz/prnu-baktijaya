            ...
            <form wire:submit.prevent="submit" class="p-8 md:p-12 space-y-8">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    @guest
                        <div class="space-y-2">
                            <label
                                class="block text-sm font-bold text-gray-700 dark:text-gray-300 uppercase tracking-wider">Password</label>
                            <input type="password" wire:model="password"
                                class="w-full px-5 py-3 rounded-2xl bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 focus:ring-2 focus:ring-primary/50 outline-none text-gray-800 dark:text-white transition-all shadow-inner">
                            @error('password') <span class="text-xs text-rose-500 font-bold mt-1">{{ $message }}</span>
                            @enderror
                        </div>

                        <div class="space-y-2">
                            <label
                                class="block text-sm font-bold text-gray-700 dark:text-gray-300 uppercase tracking-wider">Konfirmasi
                                Password</label>
