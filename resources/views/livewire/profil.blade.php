                ...
                <div class="lg:w-1/2">
                    <div class="relative group max-w-[280px] mx-auto">
                        ...
                        <img alt="PRNU Baktijaya Activity"
                            class="relative rounded-3xl shadow-2xl w-full aspect-[4/5] object-cover border-4 border-white dark:border-white/10"
                        ...
                        <div
                            class="absolute -bottom-6 -left-6 bg-white dark:bg-background-dark p-6 rounded-2xl shadow-xl border border-primary/10 dark:border-white/10 hidden md:block">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div>
                <div class="flex items-center gap-4 mb-10">
                    <h3
                        class="text-xl font-black text-primary dark:text-white uppercase tracking-widest bg-primary/10 px-6 py-2 rounded-xl">
                        Majelis Tanfidziyah</h3>
                    <div class="flex-1 h-px bg-primary/20 dark:bg-white/10"></div>
                </div>
                @if($tanfidziyah->isEmpty())
                    <div class="text-center py-8 text-gray-500">Belum ada data pengurus Tanfidziyah.</div>
                @else
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                        @foreach($tanfidziyah as $t)
                            <div
                                ...
                                @else
                                    <div class="size-16 rounded-full bg-primary/5 flex items-center justify-center border-2 border-primary/10 dark:border-white/5 shrink-0">
                                ...
                                <div>
                                    ...
                                    <h4 class="text-lg font-bold text-primary dark:text-white leading-tight">{{ $t->name }}</h4>
                                </div>
                            </div>
                        @endforeach
                    </div>
