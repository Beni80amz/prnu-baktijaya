                ...
                <div class="max-w-3xl mx-auto space-y-8 text-white">
                    ...
                    @if(count($dawuhs) > 0)
                        <div x-data="{ 
                            ...
                            class="min-h-[220px] flex flex-col items-center">
                            <div
                            ...
                            <div class="relative w-full">
                                <template x-for="(d, index) in dawuhs" :key="index">
                                    <div x-show="activeDawuh === index" x-transition:enter="transition ease-out duration-1000"
                                        x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100"
                                        x-transition:leave="transition ease-in duration-800 absolute inset-x-0 top-0"
                                        x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0"
