<div>
    <article>
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <!-- Share Buttons (Synced with News Page) -->
            <div class="flex items-center gap-4 mb-8 pb-8 border-b border-primary/10 dark:border-white/10">
                ...
                <a href="https://www.instagram.com/" target="_blank"
                    class="w-10 h-10 flex items-center justify-center rounded-full bg-[#E4405F] text-white hover:opacity-90 transition-opacity"
